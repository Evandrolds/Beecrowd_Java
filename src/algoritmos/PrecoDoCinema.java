...
/**
        ...
        * que você faça muitos balões e que, acima de tudo,
        * você se divirta!
        * Lembre que você sempre pode pedir esclarecimento quando não entender direito a descrição de um problema. 
        * Lembre-se também que às 17:30 os juízes automáticos serão desligados e a competição entrará em modo blind,
        ...
        * fornecidos com exatos dois dígitos após o ponto separador decimal,
        ...
        * O valor deve ser acompanhado do símbolo % 
        * e conter exatos dois dígitos após o ponto separador decimal.

 *
 * @author Evandro
 */
public class PrecoDoCinema {
    public static void main(String[] args) {
        try(Scanner sc = new Scanner(System.in)){
            ...
            System.out.print("% \nO valor de aumento foi de R$" + String.format("%.2f", valor)+"\n");
        }
    }
}
